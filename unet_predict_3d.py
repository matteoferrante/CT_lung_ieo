...
base_path=r"D:\FISICA MEDICA\CT_LUNG\IEO_Images_RTSS_clinical data_pseudoanonymized"
...
for p in patients[:4]:
    ...
    if os.path.isdir(patient_dir):
        ...
        x_p,min_idx,max_idx=load_and_prepare_slices(slices)
        X_test.append(x_p)
        ...
        filename = os.path.join(patient_dir,"Pred",f"{p}.nrrd")
        nrrd.write(filename, roi_pred)
